...
async function main(projectName) {
  ...
  console.log(`\n${colors.green('>>')} Creating your HTML/Sass folder structure...`);
  console.log(
  ...
  console.log(
    `\n${colors.green(
      ...
      'If you appreciate this project, give this repository a star on Github:'
    )}\nhttps://github.com/PlayeMatthieu/html-sass-boilerplate`
  );
}
